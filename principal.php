							...
							>
								...
								><div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
									...
									<div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
										<nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="layout-static.html">Agregar usuario</a><a class="nav-link" href="layout-sidenav-light.html">lista de administradores</a></nav>
									</div>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Panel de auditor</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Control de pagos</li>
						</ol>
                        <div class="row">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Ragos pendientes</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">detalles</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
									</div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header"><i class=""></i>Pagar con tarjeta</div>
                                    <div class="card-body"><canvas id="" width="100%" height="40"></canvas></div>
								</div>
							</div>
                            <div class="col-xl-6">
                                <div class="card mb-4">
                                    <div class="card-header"><i class=""></i>Pagar con paypal</div>
                                    <div class="card-body"><canvas id="mt" width="100%" height="40"></canvas></div>
								</div>
							</div>
